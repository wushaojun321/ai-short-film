...
12. 真实摄影要求：必须写入"真人演员定妆照、真实皮肤纹理、自然毛孔、真实织物、棚拍摄影、电影级写实光影"
...
7. prompt 必须是中文写实影视参考提示词，禁止动漫、插画、游戏CG、二次元、卡通、3D建模。
8. prompt 必须明确写出“沿用同一人物资产包的共享面部基准”，同一角色不同造型只改变服装、妆发、伤势、道具和场景状态。
